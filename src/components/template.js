      ...
      <div className="f-cont" id="fcont">
        ...
        <div className="fbtm" id="fbtm">
          <ul id="footer1">
            <h2>Learn More</h2>
            <li>
              <a id="link11" href="link11">
                link11
              </a>
            </li>
            <li>
              <a id="link12" href="link12">
                link12
              </a>
            </li>
            <li>
              <a id="link13" href="link13">
                link13
              </a>
            </li>
            <li>
              <a id="link14" href="link14">
                link14
              </a>
            </li>
          </ul>
          <ul id="footer2">
            <h2>services</h2>
            <li>
              <a id="link21" href="link21">
                link21
              </a>
            </li>
            <li>
              <a id="link22" href="link22">
                link22
              </a>
            </li>
            <li>
              <a id="link23" href="link23">
                link23
              </a>
            </li>
            <li>
              <a id="link24" href="link24">
                link24
              </a>
            </li>
            <li>
              <a id="link25" href="link25">
                link25
              </a>
            </li>
            <li>
              <a id="link26" href="link26">
                link26
              </a>
            </li>
          </ul>
          <ul id="footer3">
            <h2>The industry</h2>
            <li>
              <a id="link31" href="link31">
                link31
              </a>
            </li>
            <li>
              <a id="link32" href="link32">
                link32
              </a>
            </li>
            <li>
              <a id="link33" href="link33">
                link33
              </a>
            </li>
            <li>
              <a id="link34" href="link34">
                link34
              </a>
            </li>
          </ul>
          <ul id="footer4">
            ...
            <li>
              <a id="link41" href="link41">
                link41
              </a>
            </li>
            <li>
              <a id="link42" href="link42">
                link42
              </a>
            </li>
            <li>
              <a id="link43" href="link43">
                link43
              </a>
            </li>
            <li>
              <a id="link44" href="link44">
                link44
              </a>
            </li>
          </ul>
          <ul id="footer5">
            <h2>heading5</h2>
            <li>
              <a id="link51" href="link51">
                link51
              </a>
            </li>
            <li>
              <a id="link52" href="link52">
                link52
              </a>
            </li>
            <li>
              <a id="link53" href="link53">
                link53
              </a>
            </li>
            <li>
              <a id="link54" href="link54">
                link54
              </a>
            </li>
          </ul>
          ...
          <div className="fab1">
            ...
            <address>
              <h3>
                Binary Center <br />
                <span>
                  Chowk road Dumraon <br />
                  Buxar, Bihar, 802119
                </span>
              </h3>
              <h5>
                Phone: <a href="tel:+916291388958">+916291388958</a>
                <br />
                Email:{" "}
                <a href="mailto:devrajiit46@gmail.com">devrajiit46@gmail.com</a>
              </h5>
            </address>
          </div>
          <div className="fab2">
